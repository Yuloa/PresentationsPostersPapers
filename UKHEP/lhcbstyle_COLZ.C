...
"     Problems, suggestions, contributions to Thomas.Schietinger@cern.ch" 
 << endl;
cout << "Claires version for COLZ plots " << endl;
...
lhcbStyle->SetPadLeftMargin(0.1);
...
lhcbStyle->SetTitleSize(0.04,"x");
lhcbStyle->SetTitleSize(0.04,"y");
...
lhcbStyle->SetOptFit(1); // show probability, parameters and errors
